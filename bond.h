...
public:
  ...
  Bond(double sigma, double tau, double radius, double kn, double ks, double area, double I, double J) :
    sigmac_(sigma),
    tauc_(tau),
    rad_(radius),
    kn_(kn),
  ...
  Bond(double tstx, double tsty, double tstz, double tsrx, double tsry, double tsrz, double tbrx, double tbry, double tbrz, double ttrx, double ttry, double ttrz) :
...
private:
  double sigmac_, tauc_, rad_, kn_, ks_;
  int partid_[2];
  double force_n_[3], force_st_[3], force_sr_[3], torque_st_[3], torque_sr_[3], torque_br_[3], torque_tr_[3];
