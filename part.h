...
public:
    ...
    Part(double x, double y, double z, double x0, double y0, double z0, double q0, double q1, double q2, double q3, double u, double v, double w, double omx, double omy, double omz) :
        r_{x, y, z},
        r0_{x0, y0, z0},
        q_{q0, q1, q2, q3},
        U_{u, v, w},
    ...
    Part(double u_old, double v_old, double w_old, double omx_old, double omy_old, double omz_old, double fx_old, double fy_old, double fz_old, double tx_old, double ty_old, double tz_old) :
...
private:
    double r_[3], r0_[3], q_[4], U_[3], U_old_[3], om_[3], om_old_[3], f_[3], f_old_[3], t_[3], t_old_[3], m_, d_;
